...
const NewCartPageHoc = WrappedComponent => {
  ...
  return class extends React.Component {
    ...
    getCartPageData() {
        ...
        console.log("inside getCartPage")
        ...
        axios.get('http://localhost:1050/importCart')
        .then(res=> {
            //console.log(res.data)
            this.onActionSuccess(res.data, null)
        })
        .catch(err=> {
            console.log(err)
...
NewCartPageHoc.propTypes = {
  analytics: PropTypes.func,
  storeData: PropTypes.func,
  updateStoreData: PropTypes.func
};

NewCartPageHoc.defaultProps = {
  updateStoreData: () => {},
  storeData: () => {},
  analytics: () => {}
};

export default NewCartPageHoc;
