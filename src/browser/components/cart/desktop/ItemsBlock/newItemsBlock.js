...
import ItemContainer from './ItemContainer/newItemContainer.js';
...
import NewBulkActionStrip from '../../common/BulkActionStrip/NewBulkActionStrip.js';
...
class NewItemsBlock extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
